...
var audioPlayer = (function() {
    let audio = new Audio(), str = '', id = Math.random().toString(36).substr(2, 9),
        player = { 
            ...
            list: [
                { title: 'Szabaditó - Győzelem Gyülekezet', src: 'http://gyozelem.ro/mp3/szabadito-gyozelem-gyulekezet.mp3', duration: 0 },
                { title: 'Eljöttél - Győzelem Gyülekezet', src: 'http://gyozelem.ro/mp3/eljottel-gyozelem-gyulekezet.mp3', duration: 0 },
            ],
            button: {
                play: {},
                pause: {},
